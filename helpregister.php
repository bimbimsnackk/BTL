...
$link = mysqli_connect('localhost','root','','sinhvien','3306') or die('kết nối thất bại ');
...
echo '<script language="javascript">alert("Đăng ký thành công!"); window.location="sinhvien/loginsv.php";</script>';
