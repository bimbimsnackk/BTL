                        ...
                        <table width="100%" padding="5px">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($r = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>$tieude</td>";
                                    echo "<td>$noidung</td>";
                                    echo " <td style='text-align: center;'> <a href='chucnang/sualop.php?id=$baidang'><input id='btnSua' type='button' value='sửa' '></a>   <a href='chucnang/xoathongbao.php?id=$baidang'><input id='btnXoa' type='button' value='xóa'></a></td>";
                                    // <a href='chitietthongbao.php?id=$baidang'><input id='btnChitiet' type='button' value='chi tiết' '></a>
                                }
                            }
